...
function setCurrentSong(songId) {
    $.ajax({
        ...
        success: function (result) {
            alert("Current song set to '" + result.title + "' by " + result.artist.name + ".");
            html = "<h2>" + result.title + "</h2><div class='byline'>" + result.artist.name + "</div><div class='lyric'>" + result.lyric + "</div>";
